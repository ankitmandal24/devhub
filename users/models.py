...
class Profile(models.Model):
    ...
    year_and_branch = models.CharField(max_length=255, blank=True,null=True)
    profile_image = models.ImageField(null=True, blank=True,upload_to='profiles/', default ="profiles/dp.jpg"  )
